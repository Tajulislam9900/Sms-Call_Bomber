#coder  : TAJUL ISLAM RABBI
#github : https://github.com/Tajulislam9900/
#---------color code--------#
I='\033[1;32m'
Q="\x1b[00m"
dt = f"{Q}[{I}•{Q}]"
...
def clear():
    ...
    print(logo)
    print(22*f'{Q} -')
    print(f' {dt} CODER    : T . I . R Cyber Team  ')
    print(f' {dt} Facebook : TAJUL ISLAM RABBI ')
    print(f' {dt} Github   : Tajulislam9900')
    print(22*' -')
#-------line-------------#
def line():
    print(22*' -')
...
def menu():
  clear()
  print(f' {dt} [01] T . I . R  CALL BOMNER')
  ...
  if user in ['01', '1']:
    ...
    os.system('xdg-open https://github.com/Tajulislam9900')
  else:
